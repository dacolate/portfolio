        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-1 xl:pb-10">
          ...
          <div className="flex flex-col xl:flex-row items-center gap-8">
            ...
            <div className="mb-8 xl:mb-0">
              ...
              justify-center items-center text-accent text-base hover:bg-accent hover:text-primary hover:transition-all duration-500" /></div>
          ...
          <div><Photo className="order-1 xl:order-none mb-8 xl:mb-0" /></div>
        </div>
       </div>
